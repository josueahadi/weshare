...
<head>
    ...
    <title>WeShare - Account Settings</title>
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="checkbox" class="custom-control-input" onclick="show_password()">
                    ...
                    <tr>
                        <td style="font-weight: bold;">Recovery Code</td>
                        <td>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title">Account Recovery Code</h4>
                                        </div>
                                        <div class="modal-body">
                                            <form action="recovery.php?id=<?php echo $user_id; ?>" method="POST" id="f">
                                                ...
                                                <input class="btn btn-default" type="submit" name="sub" value="Save"
                                                    style="width: 100px;"><br><br>
                                                <pre>The answer to the above question will be your account password reset code.</pre>
                                                <br>
                                            </form>
                                            <?php
                                            ...
                                            if (isset($_POST['sub'])) {
                                                ...
                                                if ($bfn == "") {
                                                    ...
                                                    echo "<script>window.open('account_settings.php?u_id=$user_id', '_self')</script>";
                                                    ...
                                                    if ($run) {
                                                        ...
                                                        echo "<script>alert('Error updating your recovery code!')</script>";
                                                        echo "<script>window.open('account_settings.php?u_id=$user_id', '_self')</script>";
                                                    }
                                                }
                    ...
                    <tr align="center">
                        <td colspan="6">
                            <br>
                            <input type="submit" class="btn btn-primary" name="update" style="width: 200px;"
                                value="Save Changes">
                        </td>
                    </tr>
                </table>
...
<?php
    ...
    if (isset($_POST['update'])) {
        ...
        $run = mysqli_query($con, $update);
            ...
            if ($run) {
                //  echo "<script>alert('All changes saved')</script>";
                 echo "<script>window.open('account_settings.php?u_id=$user_id', '_self')</script>";
            }
    }
