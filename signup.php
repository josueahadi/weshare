		...
		<div class="col-sm-4 float-right form">
			<form  action="" method="post">
				...
				<div class="input-group">
					...
					<input id="email" type="email" class="form-control" placeholder="Email" name="u_email" autocomplete="off" requireD>
				</div><br>
				...
				<div class="input-group">
					...
					<input id="password" type="password" class="form-control" placeholder="Password" name="u_pass" required>
					<br>
				</div><span class="text-small text-dark">Must be a minimum of 6 characters</span><br><br>
				...
				<div class="input-group">
					...
					<input type="date" class="form-control input-md" placeholder="Birthday" name="u_birthday" required>
				</div><br>

				Already have an account?<a data-toggle="tooltip" title="Signin" href="signin.php"> Login.</a><br><br>
				<button class="btn btn-primary btn-block" name="sign_up">Sign up for WeShare</button>
